                ...
                <div class="card overflow-hidden">
                    <div class="bg-login text-center">
                        ...
                        <div class="position-relative">
                            ...
                            <p class="text-white-50 mb-0">Oturum aç ve panelin keyfini sür!</p>
                        ...
                        <div class="p-2">
                            <form class="form-horizontal panel_loginform" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="username" class="form-control" id="username" required placeholder="Email giriniz">
                                </div>
